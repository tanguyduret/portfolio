...
export const Footer: React.FC = () => {
  ...
  return (
    <section id="contact" className="bg-black pt-24 pb-12 md:pt-32 md:pb-16 text-ivory relative overflow-hidden">
       {/* Ambient glow */}
      ...
      <div className="reveal-section container mx-auto px-6 md:px-8 max-w-6xl relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 border-t border-white/10 pt-12">
          ...
          <div className="flex flex-col gap-8 w-full md:max-w-lg">
              <div>
                <p className="text-steel text-xs uppercase tracking-widest mb-4">{content.footer.contact_title}</p>
                <a
              ...
              {/* Buttons Container - Clean & Aligned */}
              <div className="flex flex-col sm:flex-row gap-4 w-full">
                  ...
                  {/* CV Download Button - No Icon inside, Same Size */}
                  <a href="/Tanguy_Duret_CV.pdf" download target="_blank" rel="noopener noreferrer" className="flex-1">
